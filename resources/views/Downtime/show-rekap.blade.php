                    ...
                    <div class="card-header bg-gradient-primary border-bottom-0 rounded-top-4 p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="modal-title fw-bold mb-0">Rekap Downtime Details</h5>
                            </div>
                            <a href="{{ route('rekapdowntime.index') }}" class="btn btn-outline-secondary hover-scale">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="p-3 bg-light rounded-3 info-card hover-shadow">
                                ...
                                <div class="info-item mb-3">
                                    <label class="text-muted small">Maintenance Repair</label>
                                    <div class="fw-medium">{{ $downtime->maintenance_repair ?? 'N/A' }}</div>
                                </div>
                                <div class="info-item mb-3">
                                    <label class="text-muted small">Root Cause</label>
                                    <div class="fw-medium">{{ $downtime->root_cause ?? 'N/A' }}</div>
                                </div>
                                <div class="info-item mb-3">
                                    <label class="text-muted small">Action Taken</label>
                                    <div class="fw-medium">{{ $downtime->action_taken ?? 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info-item mb-3">
                                            ...
                                            <div>
                                                <span
                                                    class="badge bg-{{ $downtime->status == 'Open' ? 'warning' : 'success' }} hover-scale">
                                                    {{ $downtime->status }}
                                                </span>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-10">
                <div class="card shadow-lg transition-all">
                    ...
                    <div class="card-header bg-gradient-primary border-bottom-0 rounded-top-4 p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="modal-title  mb-0">DETAIL REKAPITULASI DOWNTIME</h5>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Maintenance & IPQC Sections Side by Side -->
                        <div class="row mt-4">
                            <!-- Maintenance & Problem Section -->
