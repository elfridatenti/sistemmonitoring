        ...
        <div class="dashboard-cards">
            ...
            <div class="stat-card">
                ...
                <div class="stat-badges">
                    <span class="stat-badge badge-waiting">
                        <span class="badge-dot dot-waiting"></span>
                        Menunggu: {{ $data['downtime']['Menunggu'] }}
                    </span>
                    <span class="stat-badge badge-processing">
                        <span class="badge-dot dot-processing"></span>
                        Diproses: {{ $data['downtime']['Sedang_Diproses'] }}
                    </span>
                    <span class="stat-badge badge-qc">
                        <span class="badge-dot dot-qc"></span>
                        QC: {{ $data['downtime']['Menunggu_QC_Approve'] }}
                    </span>
                    <span class="stat-badge badge-completed">
                        <span class="badge-dot dot-completed"></span>
                        Selesai: {{ $data['downtime']['Completed'] }}
                    </span>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-badges">
                    <span class="stat-badge badge-waiting">
                        <span class="badge-dot dot-waiting"></span>
                        Menunggu: {{ $data['setup']['Menunggu'] }}
                    </span>
                    <span class="stat-badge badge-processing">
                        <span class="badge-dot dot-processing"></span>
                        Diproses: {{ $data['setup']['Sedang Diproses'] }}
                    </span>
                    <span class="stat-badge badge-qc">
                        <span class="badge-dot dot-qc"></span>
                        QC: {{ $data['setup']['Menunggu_QC_Approve'] }}
                    </span>
                    <span class="stat-badge badge-completed">
                        <span class="badge-dot dot-completed"></span>
