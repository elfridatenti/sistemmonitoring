...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Print Media Styles */
        @media print {
            .sidebar, .header, .logout-container, .mobile-menu-toggle {
        ...
        <div class="sidebar">
            <div class="sidebar-logo">
                <div class="logo-header-container">
                    ...
                    <h2 class="text-center">SISTEM INFORMASI </br> MOLDING</h2>
                </div>
            </div>
            ...
            <nav class="nav-menu">
                ...
                @endif
                {{-- Setup Menu - Role-based access --}}
                @if (in_array($userRole, ['admin', 'leader', 'teknisi']))
                    <div class="menu-group">
                        ...
                        <div id="setupSubmenu" class="submenu">
                            ...
                            @if (in_array($userRole, ['leader', 'teknisi', 'admin']))
                                <a href="{{ route('setup.index') }}"
                                    class="nav-link {{ request()->routeIs('setup.index') ? 'active' : '' }}">
                                    <span>Mesin Setup</span>
                                </a>
                            @endif
            
                            @if ($userRole === 'teknisi')
                                <a href="{{ route('finishsetup.create') }}"
                                    class="nav-link {{ request()->routeIs('finishsetup.create') ? 'active' : '' }}">
                            ...
                            @if (in_array($userRole, ['admin', 'teknisi']))
                                <a href="{{ route('rekapsetup.index') }}"
                                    class="nav-link {{ request()->routeIs('rekapsetup.index') ? 'active' : '' }}">
                                    <span>Rekapitulasi Setup</span>
                                </a>
                            @endif
                        </div>
                    </div>
                ...
                {{-- Direct access for IPQC to Rekapitulasi Setup --}}
                @if ($userRole === 'ipqc')
                    <a href="{{ route('rekapsetup.index') }}"
                        class="nav-link {{ request()->routeIs('rekapsetup.index') ? 'active' : '' }}">
                        <i class="fas fa-tools"></i>
                ...
                {{-- Downtime Menu - Role-based access --}}
                @if (in_array($userRole, ['admin', 'leader', 'teknisi']))
                    <div class="menu-group">
                        ...
                        <div id="downtimeSubmenu" class="submenu">
                            ...
                            @if (in_array($userRole, ['leader', 'teknisi', 'admin']))
                                <a href="{{ route('downtime.index') }}"
                                    ...
                                    <span>Mesin Downtime</span>
                                </a>
                            @endif
            
                            @if ($userRole === 'teknisi')
                                <a href="{{ route('finishdowntime.create') }}"
                                    class="nav-link {{ request()->routeIs('finishdowntime.create') ? 'active' : '' }}">
                                    <span>Finish Downtime</span>
                                </a>
                            @endif
            
                            @if (in_array($userRole, ['admin', 'teknisi']))
                                <a href="{{ route('rekapdowntime.index') }}"
                                    class="nav-link {{ request()->routeIs('rekapdowntime.index') ? 'active' : '' }}">
                                    <span>Rekapitulasi Downtime</span>
                                </a>
                            @endif
                        </div>
                    </div>
                ...
                {{-- Direct access for IPQC to Rekapitulasi Downtime --}}
                @if ($userRole === 'ipqc')
                    <a href="{{ route('rekapdowntime.index') }}"
                        class="nav-link {{ request()->routeIs('rekapdowntime.index') ? 'active' : '' }}">
                        <i class="fas fa-clock"></i>
